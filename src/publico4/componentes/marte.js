...
<div>
    ...
    <form id="astro1"  action="" v-on:submit.prevent="cargarInput1()" method="POST" style="display: inline-block;">
        ...
        <input list="opcionesMarte" type="text" v-model="dato1" name="nombre" id="imput1" placeholder="__marte en signo">
        <datalist id="opcionesMarte">
            <option value="marte en aries">
            <option value="marte en tauro">
            <option value="marte en geminis">
            <option value="marte en cancer">
            <option value="marte en leo">
            <option value="marte en virgo">
            <option value="marte en libra">
            <option value="marte en escorpio">
            <option value="marte en sagitario">
            <option value="marte en capricornio">
            <option value="marte en acuario">
            <option value="marte en piscis">
        </datalist>
    ...
    <form id="astro2" v-on:submit.prevent="cargarInput2()" action="" method="POST" style="display: inline-block; " >
        ...
        <input list="opcionesMarte2" type="text" v-model="dato2"name="nombre" id="imput2 "placeholder="__Marte en casa">
        <datalist id="opcionesMarte2">
            <option value="marte en casa 1">
            <option value="marte en casa 2">
            <option value="marte en casa 3">
            <option value="marte en casa 4">
            <option value="marte en casa 5">
            <option value="marte en casa 6">
            <option value="marte en casa 7">
            <option value="marte en casa 8">
            <option value="marte en casa 9">
            <option value="marte en casa 10">
            <option value="marte en casa 11">
            <option value="marte en casa 12">
        </datalist>
    ...
    <div>
        ...
        <div id="imput3"  style="float:left">
            <div v-for="(find,index) in dato3" >
                <input list="opcionesMarte3" v-model="find.value" :key="index" placeholder="__aspectos de marte">
                <datalist id="opcionesMarte3">
                    <option value="marte conjuncion ">
                    <option value="marte trigono ">
                    <option value="marte sextil ">
                    <option value="marte cuadratura ">
                    <option value="marte oposicion ">
                </datalist>
...
methods:{
    ...
    async cargarInput1(){
        ...
        if(this.dato1!=""){
        let peticionTipo={nombre:'marte_ensigno'};
        await axios.post('/carta',peticionTipo).then((response)=>{
            let texto={
                'id':14,
                'nombre':'Marte en el signo',
    ...
    async cargarInput2(){
        if(this.dato2!=""){
        let peticionTipo={nombre:'marte_encasa'};
        await axios.post('/carta',peticionTipo).then((response)=>{
            let texto={
                'id':14,
                'nombre':'Marte en la Casa',
                'definicion': response.data
            }
