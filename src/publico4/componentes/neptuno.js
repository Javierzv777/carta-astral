...
<div>
    ...
    <form id="astro1"  action="" v-on:submit.prevent="cargarInput1()" method="POST" style="display: inline-block;">
        ...
        <input list="opcionesNeptuno" type="text" v-model="dato1" name="nombre" id="imput1" placeholder="__neptuno en signo">
        <datalist id="opcionesNeptuno">
            <option value="neptuno en aries">
            <option value="neptuno en tauro">
            <option value="neptuno en geminis">
            <option value="neptuno en cancer">
            <option value="neptuno en leo">
            <option value="neptuno en virgo">
            <option value="neptuno en libra">
            <option value="neptuno en escorpio">
            <option value="neptuno en sagitario">
            <option value="neptuno en capricornio">
            <option value="neptuno en acuario">
            <option value="neptuno en piscis">
        </datalist>
    ...
    <form id="astro2" v-on:submit.prevent="cargarInput2()" action="" method="POST" style="display: inline-block; " >
        ...
        <datalist id="opcionesNeptuno2">
            <option value="neptuno en casa 1">
            <option value="neptuno en casa 2">
            <option value="neptuno en casa 3">
            <option value="neptuno en casa 4">
            <option value="neptuno en casa 5">
            <option value="neptuno en casa 6">
            <option value="neptuno en casa 7">
            <option value="neptuno en casa 8">
            <option value="neptuno en casa 9">
            <option value="neptuno en casa 10">
            <option value="neptuno en casa 11">
            <option value="neptuno en casa 12">
        </datalist>
    ...
    <div>
        ...
        <div id="imput3"  style="float:left">
            <div v-for="(find,index) in dato3" >
                <input list="opcionesNeptuno3" v-model="find.value" :key="index" placeholder="__aspectos de neptuno">
                <datalist id="opcionesNeptuno3">
                    <option value="neptuno conjuncion ">
                    <option value="neptuno trigono ">
                    <option value="neptuno sextil ">
                    <option value="neptuno cuadratura ">
                    <option value="neptuno oposicion ">
                </datalist>
...
methods:{
    ...
    async cargarInput1(){
        ...
        if(this.dato1!=""){
        let peticionTipo={nombre:'neptuno_ensigno'};
        await axios.post('/carta',peticionTipo).then((response)=>{
            let texto={
                'id':22,
                'nombre':'Neptuno en el signo',
    ...
    async cargarInput2(){
        if(this.dato2!=""){
        let peticionTipo={nombre:'neptuno_encasa'};
        await axios.post('/carta',peticionTipo).then((response)=>{
            let texto={
                'id':22,
                'nombre':'Neptuno en la Casa',
                'definicion': response.data
            }
