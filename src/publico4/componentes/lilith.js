...
<div>
    ...
    <form id="astro1"  action="" v-on:submit.prevent="cargarInput1()" method="POST" style="display: inline-block;">
        ...
        <input list="opcioneslilith" type="text" v-model="dato1" name="nombre" id="imput1" placeholder="__lilith en signo">
        <datalist id="opcioneslilith">
            <option value="lilith en aries">
            <option value="lilith en tauro">
            <option value="lilith en geminis">
            <option value="lilith en cancer">
            <option value="lilith en leo">
            <option value="lilith en virgo">
            <option value="lilith en libra">
            <option value="lilith en escorpio">
            <option value="lilith en sagitario">
            <option value="lilith en capricornio">
            <option value="lilith en acuario">
            <option value="lilith en piscis">
        </datalist>
    ...
    <form id="astro2" v-on:submit.prevent="cargarInput2()" action="" method="POST" style="display: inline-block; " >
        ...
        <datalist id="opcioneslilith2">
            <option value="lilith en casa 1">
            <option value="lilith en casa 2">
            <option value="lilith en casa 3">
            <option value="lilith en casa 4">
            <option value="lilith en casa 5">
            <option value="lilith en casa 6">
            <option value="lilith en casa 7">
            <option value="lilith en casa 8">
            <option value="lilith en casa 9">
            <option value="lilith en casa 10">
            <option value="lilith en casa 11">
            <option value="lilith en casa 12">
        </datalist>
    ...
    <div>
        ...
        <div id="imput3"  style="float:left">
            <div v-for="(find,index) in dato3" >
                <input list="opcioneslilith3" v-model="find.value" :key="index" placeholder="__aspectos de lilith">
                <datalist id="opcioneslilith3">
                    <option value="lilith conjuncion ">
                    <option value="lilith trigono ">
                    <option value="lilith sextil ">
                    <option value="lilith cuadratura ">
                    <option value="lilith oposicion ">
                </datalist>
